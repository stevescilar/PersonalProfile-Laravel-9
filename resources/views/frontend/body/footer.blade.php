                    ...
                    <div class="col-lg-4">
                        <div class="footer__widget">
                            <div class="fw-title">
                                ...
                                <h4 class="title">+254 705 549 257</h4>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="copyright__text text-center">
                               <script>document.write(new Date().getFullYear())</script> © Microsil Enterprises | &nbsp;
                                    Crafted with <i class="fas fa-heart-circle" style="color: #ffff00;"></i> by Muambi
                            </div>
                        </div>
                    </div>
                </div>
